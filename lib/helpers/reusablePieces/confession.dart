    ...
    return Column(
        ...
        children: <Widget>[
          ...
          , PhrasedParagraph([
            ...
            , Line(text: "we have erred and strayed from your ways like lost sheep.", indent: 1)
            ...
            , Line(text: "and we have done those things which we ought not to have done;", indent: 1)
            , Line(text: "and apart from your grace, there is no health in us.", indent: 1)
            ...
            , Line(text: "that we may now live a godly, righteous, and sober life,", indent: 1)
            , Line(text: "to the glory of your holy Name. Amen.", indent: 1)
          ])
