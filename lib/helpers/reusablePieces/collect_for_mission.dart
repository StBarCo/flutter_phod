    ...
    return Column(children: <Widget>[
      Container(
        ...
        child: DropdownButton(
            ...
            onChanged: (newValue) {
              setState(() {
                collectDay = (collectDay + 1) % 3;
              });
            },
            items: [
              DropdownMenuItem(value: 0, child: Text('Collect For Mission 1')),
              DropdownMenuItem(value: 1, child: Text('Collect For Mission 2')),
              DropdownMenuItem(value: 2, child: Text('Collect For Mission 3'))
            ]),
      ),
      (widget.litDay.service == "ep")
          ? EpCollectForMission(collect: collectDay)
          : MpCollectForMission(collect: collectDay)
    ]);
  }
}
